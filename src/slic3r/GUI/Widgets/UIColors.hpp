...
static const int clr_border_normal      = 0x293133; // 0xDBDBDB;
static const int clr_border_hovered  = 0x293133; // 0x00AE42;
static const int clr_border_disabled    = 0x293133; // 0xDBDBDB;

static const int clr_background_normal_light    = 0x293133;
