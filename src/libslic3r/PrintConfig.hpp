...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,                       bot_retract_speed))
    ((ConfigOptionFloat,                       retract_speed))
    ((ConfigOptionFloat,                       bot_light_intensity))
    ((ConfigOptionFloat,                       light_intensity))
    ((ConfigOptionFloat,                       rest_time_after_lift))
    ((ConfigOptionFloat,                       rest_time_after_lift2))
    ...
    ((ConfigOptionFloat,                       tsmc_retract_speed))
    ((ConfigOptionFloat,                       tsmc_bot_retract_speed))
