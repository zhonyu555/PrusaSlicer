...
static std::vector<std::string> s_Preset_print_options {
    ...
    "seam_position","staggered_inner_seams", "external_perimeters_first", "inoutin_perimeters", "invert_internals_order", "fill_density", "fill_pattern", "top_fill_pattern", "bottom_fill_pattern",
